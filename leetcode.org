...
Also people mentioned that this is similar to [[https://en.wikipedia.org/wiki/Maximum_subarray_problem][Kadane's Algorithm for Maximum Subarry Sum]].
...
Use $O(N)$ time.
**** Examples:
#+name: 53 Maximum subarry example
#+caption: 53 Maximum subarry example
#+begin_example
...
:END:
#+name: 53 Maximum subarry my solution
#+caption: 53 Maximum subarry my solution
#+begin_src ein-python :session localhost :results output code :noweb yes
<<imports for typing>>
...
#+RESULTS: 53 Maximum subarry my solution
#+begin_src none
6
1
#+end_src
...
**** Leetcode solution
Not available.
#+name: 53 Maximum subarry leetcode solution
#+caption: 53 Maximum subarry leetcode solution
#+begin_src ein-python :session localhost :results output code :noweb yes
<<imports for typing>>
...
#+name: 53 Maximum subarry my solution O(1) space
#+caption: 53 Maximum subarry my solution O(1) space
#+begin_src ein-python :session localhost :results output code :noweb yes
<<imports for typing>>
...
#+RESULTS: 53 Maximum subarry my solution O(1) space
#+begin_src none
6
#+end_src
