...
** TODO 355 Design twitter                                     :medium:heap:
*** Description
:LOGBOOK:
...
** TODO 778 Swim in rising water                                 :heap:hard:
*** Description
:LOGBOOK:
...
For example, when we are at ~grid[0][1]~, ~2~, and we find that ~5~ and ~7~ are larger than another option ~3~, we can /swim/ to ~grid[1][0]~, ~3~, in no time.
...
#+CAPTION: Clock summary at [2020-04-27 Mon 16:24]
| Headline                             |      Time |
|--------------------------------------+-----------|
| *Total time*                         | *1d 1:33* |
|--------------------------------------+-----------|
...
| Algorithms                           |      0:40 |
| Techniques                           |      0:18 |
| CLRS Notes & Yufei Tao lecture notes |     10:36 |
| Exporting                            |      0:38 |
| Fix up                               |      2:48 |
#+END:
